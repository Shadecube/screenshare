    ...
    */
    ...
    _renderToolboxContent() {
        const {
            ...
            _raisedHand,
            _showParticipantCount, _subject, _visible, _visibleButtons, 
            t
        } = this.props;
        ...
        const maxNumberOfButtonsPerGroup = this.state.windowWidth > 640 ? Math.floor(
            (
                this.state.windowWidth
                    - (140 * 2) // padding of left and right
...
function _mapStateToProps(state) {
    ...
    const dialOutEnabled = participant?.shadeCubeRole === PARTICIPANT_ROLE.MODERATOR  && conference && conference.isSIPCallingSupported();;
    ...
    return {
        ...
        _hideInviteButton:
            iAmRecorder || (!addPeopleEnabled && !dialOutEnabled)  || true,
